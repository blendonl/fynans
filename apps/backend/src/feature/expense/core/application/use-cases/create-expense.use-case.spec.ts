...
describe('CreateExpenseUseCase', () => {
  ...
  let createTransactionUseCase: Record<string, jest.Mock>;
  ...
  beforeEach(() => {
    ...
    createTransactionUseCase = {
      execute: jest.fn().mockResolvedValue({ id: 'transaction-1' }),
    };
    storeService = {
  ...
  it('stores (price - discount) * quantity as the transaction value', async () => {
    ...
    const dto = createTransactionUseCase.execute.mock.calls[0][0];

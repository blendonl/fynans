...
exports.CreateStoreItemCategoryUseCase = void 0;
const common_1 = require("@nestjs/common");
let CreateStoreItemCategoryUseCase = class CreateStoreItemCategoryUseCase {
    ...
    async validate(dto) {
        ...
        if (dto.parentId) {
            const parent = await this.storeItemCategoryRepository.findById(dto.parentId);
            if (!parent) {
...
exports.CreateStoreItemCategoryUseCase = CreateStoreItemCategoryUseCase;
exports.CreateStoreItemCategoryUseCase = CreateStoreItemCategoryUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)('StoreItemCategoryRepository')),
    __metadata("design:paramtypes", [Object])
], CreateStoreItemCategoryUseCase);
//# sourceMappingURL=create-store-item-category.use-case.js.map